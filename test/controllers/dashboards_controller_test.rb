...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference("Dashboard.count") do
      post dashboards_url, params: { dashboard: { active: @dashboard.active, description: @dashboard.description, name: @dashboard.name, user_id: @dashboard.user_id } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { active: @dashboard.active, description: @dashboard.description, name: @dashboard.name, user_id: @dashboard.user_id } }
